...
export class DataTableDirective implements OnChanges, DoCheck {
    ...
    public ngOnChanges(changes: {[key: string]: SimpleChange}): any {
        ...
        if (changes['sortBy'] || changes['sortOrder']) {
            if (!_.includes(['asc', 'desc'], this.sortOrder)) {
                console.warn('datatable: value for input mfSortOrder must be one of ["asc", "desc"], but is:', this.sortOrder);
                this.sortOrder = 'asc';
            }
            if (this.sortBy) {
